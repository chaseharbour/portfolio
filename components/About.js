      ...
      <article className={aboutStyles.container}>
        <aside className={aboutStyles.asideContainer}>
          ...
          <p className={aboutStyles.aboutBodyPrimary}>
            ...
            to help individuals and companies create and interact with
        ...
        <aside className={aboutStyles.asideContainer}>
          ...
          <p className={aboutStyles.aboutBodySecondary}>
            ...
            in meaningful and accessible ways. A passion was sparked and I
            sought to build my skills to bring those quality experiences to as
